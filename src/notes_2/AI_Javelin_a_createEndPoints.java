...
public class AI_Javelin_a_createEndPoints {
...
//	Now that we have a webserver that continuously runs, we need to define end points that users and other applications 
...
//	    // HTTP GET REQUEST to http://localhost:9000/get-request
//	    app.get("/get-request", ctx -> {
//	        //logic to be executed when this end point is hit
//	        ctx.result("get request end point hit!");
//	    });
//
//
//	    // HTTP POST REQUEST to http://localhost:9000/post-request
//	    app.post("/post-request", ctx -> {
//	        //logic to be executed when this end point is hit
//	        ctx.result("post request end point hit!");
//	    });
//	}
