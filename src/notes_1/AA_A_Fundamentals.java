...
////	    Runtime: This is when Java uses the JIT. The bytecode that the developer wrote is then turned into instructions 
//	for the JVM to execute.
////
////	Recap
////
////	The JDK contains tools for Java development as well as the JRE. The JRE contains the JVM, which actually executes the 
//	Java bytecode and runs it on the specific operating system on which it is installed.
//
//
...
////	Since every machine can implement its own JREs and JVMs, Java source code does not have to be rewritten to be 
//	machine-specific. This is known as Write Once, Run Anywhere (WORA).
//
//	
////	"Hello, World!" programs are used to illustrate how the process of coding works, especially for introductory programmers.
////	Sometimes, more experienced programmers use "Hello, World!" programs as a "sanity test" to make sure the components 
//	of a language have been correctly installed.
...
////	    Increment and decrement operators (++, --). Postfix we first use the variable then increment/decrement. Prefix 
//	we first increment/decrement then use the variable.
////	    Ternary operators
//
//	    
//	    
...
////	The main steps of debugging include identifying the problem, reproducing the issue, isolating the source, implementing a 
//	fix, and testing the revised implementation.
////	Various techniques are used in debugging, such as using print statements, interactive debugging tools, automated tests, and 
//	code reviews.
////	Effective debugging practices include compiling/running code frequently, using comments strategically, applying binary 
//	search for complex errors, and seeking help when needed.
////	The debugging process is often iterative and requires patience, systematic thinking, and sometimes creative problem-solving 
//	skills.    
//	
//	
...
////	values that are specific to a method and references to
////	objects referred to by the method that are in the heap.
////        Access to this memory is in Last-In-First-Out (LIFO) order. Whenever we call a new method, a new block is created 
//	on top of the stack that contains values specific to 
...
// New objects are always created in heap space, and the references to these 
////	objects are stored in stack memory.
////        These objects have global access, and we can access them from anywhere in the application.
////    We can break this memory model down into smaller parts, called generations, which are:
////        Young Generation – this is where all new objects are allocated and aged. A minor garbage collection occurs 
//when this fills up.
//////        Old or Tenured Generation – this is where long-surviving objects are stored. When objects are stored in the 
//Young Generation, a threshold for the object's age is set, 
...
//////        It's accessed via complex memory management techniques that include the Young Generation, Old or Tenured 
//Generation, and Permanent Generation.
//////        If heap space is full, Java throws java.lang.OutOfMemoryError.
//////        Access to this memory is comparatively slower than stack memory.
//////        This memory, in contrast to the stack, isn't automatically deallocated. It needs a Garbage Collector to 
//free up unused objects in order to maintain efficient memory usage.
